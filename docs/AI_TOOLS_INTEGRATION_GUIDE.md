...
| 模块 | 用途 | 关系 |
|------|------|------|
| **AI Tools（AI 工具）** | 让 AI 能够调用外部 API 或 MCP 服务 | 每个工具关联一个 ExtractionSchema（1对1） |
...
```json
{
  ...
  "data": {
    "config": {
      "modelId": "model-uuid",
      "systemPrompt": "你是一个智能客服助手，可以帮用户查询天气和发送通知",
      "temperature": 0.8,
      "messages": [
...
// 工作流执行响应
{
  "workflowId": "xxx",
  "status": "PAUSED",
  "pauseReason": "TOOL_PARAM_COLLECTION",
  "pauseMessage": "请问您想查询哪个城市的天气？",
  "context": {
    "toolCallState": {
